...
public class PokerLabel extends JLabel implements Comparable {
    ...
    public void turnUp() {
        this.setIcon(new ImageIcon("src/main/java/com/wanglj/wanglj2022/chinesePlate/images/poker/" + id + ".jpg"));
    }

    public void turnDown() {
        this.setIcon(new ImageIcon("src/main/java/com/wanglj/wanglj2022/chinesePlate/images/poker/down.jpg"));
    }
