...
import com.wanglj.wanglj2022.chinesePlate.client.model.Player;
import com.wanglj.wanglj2022.chinesePlate.client.model.Poker;
import com.wanglj.wanglj2022.chinesePlate.client.model.PokerLabel;
import com.wanglj.wanglj2022.chinesePlate.client.thread.ChuPaiThread;
import com.wanglj.wanglj2022.chinesePlate.client.thread.CountThread;
import com.wanglj.wanglj2022.chinesePlate.client.thread.ReceiveThread;
import com.wanglj.wanglj2022.chinesePlate.client.thread.SendThread;
import com.wanglj.wanglj2022.chinesePlate.client.utl.GameUtil;
import com.wanglj.wanglj2022.chinesePlate.client.utl.PokerRule;
import com.wanglj.wanglj2022.chinesePlate.client.utl.PokerType;
...
public class MainFrame extends JFrame {
    ...
    public void init()  //窗口初始化
    {
        ...
        chupaiJLabel.setIcon(new ImageIcon("src/main/java/com/wanglj/wanglj2022/chinesePlate/images/bg/chupai.png"));
        ...
        buchuJLabel.setIcon(new ImageIcon("src/main/java/com/wanglj/wanglj2022/chinesePlate/images/bg/buchupai.png"));
    ...
    public void getLord() {
        ...
        lordLabel1.setIcon(new ImageIcon("src/main/java/com/wanglj/wanglj2022/chinesePlate/images/bg/jiaodizhu.png"));
        ...
        lordLabel2.setIcon(new ImageIcon("src/main/java/com/wanglj/wanglj2022/chinesePlate/images/bg/bujiao.png"));
    ...
    public void showMsg(int typeid) //显示“不抢”或“不出”
    {
        ...
        if (typeid == 1) {
            msgLabel.setIcon(new ImageIcon("src/main/java/com/wanglj/wanglj2022/chinesePlate/images/bg/buqiang.png"));
        }
        if (typeid == 3) {
            msgLabel.setIcon(new ImageIcon("src/main/java/com/wanglj/wanglj2022/chinesePlate/images/bg/buchu.png"));
        }
    ...
    public void showLordIcon(int playerid) {
        ...
        LordIconLabel.setIcon(new ImageIcon("src/main/java/com/wanglj/wanglj2022/chinesePlate/images/bg/dizhu.png"));
